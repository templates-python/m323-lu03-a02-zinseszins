...
def test_compound_interest():
    ...
    assert round(main.compound_interest(2000, 0.03, 10), 2) == 2685.68
...
def test_compound_interest_edge_cases():
    ...
    assert round(main.compound_interest(1000, -0.05, 5), 2) == 770.45

    # Test mit negativer Laufzeit (sollte in der Realität nicht vorkommen, aber gut für die Funktion zu handhaben)
    assert main.compound_interest(1000, 0.05, -5) == 1000  # In diesem Fall könnte man auch eine Exception werfen
    ...
    assert round(main.compound_interest(1000, 0.01, 1000), 2) == 2.09e+13

    # Test mit einem sehr niedrigen Zinssatz
    assert round(main.compound_interest(1000, 0.000001, 1000), 2) == 1001.00
